  ...
  return (
    <div  className=' rounded-lg  mt-12 p-4 md:p-8 w-full  bg-slate-200'>
        <section className='flex flex-col md:grid  md:grid-cols-3 gap-5  auto-rows-[300px]'>
            ...
            <div className='rounded-xl  border hidden md:flex bg-white shadow-md overflow-y-scroll p-3 '>
            ...
            <div className='rounded-xl min-h-[300px] border  p-3 bg-white shadow-md '>fffd</div>
            <div className='rounded-xl  border min-h-[300px] col-span-2 p-3 bg-white shadow-md '>wwww</div>
        </section>
    </div>
  )
}
